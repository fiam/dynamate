...
mod tests {
    ...
    fn test_simple_comparison() {
        ...
        assert_eq!(result, DynamoExpression::Comparison {
    ...
    fn test_not_equal_operators() {
        ...
        assert_eq!(expr1, DynamoExpression::Comparison {
    ...
    fn test_complex_expression_with_not_equal() {
        ...
        match result {
            DynamoExpression::And(left, right) => {
                match (*left, *right) {
                    (
                        DynamoExpression::Comparison { left: left_op, operator: Comparator::NotEqual, right: right_op },
                        DynamoExpression::Comparison { left: left_op2, operator: Comparator::GreaterOrEqual, right: right_op2 }
                    ) => {
    ...
    fn test_mixed_not_equal_operators() {
        ...
        let result = parse_dynamo_expression("status != \"inactive\" OR role <> \"guest\"").unwrap();
        match result {
            DynamoExpression::Or(left, right) => {
                match (*left, *right) {
                    (
                        DynamoExpression::Comparison { operator: Comparator::NotEqual, .. },
                        DynamoExpression::Comparison { operator: Comparator::NotEqual, .. }
                    ) => {
    ...
    fn test_between_expression() {
        ...
        assert_eq!(result, DynamoExpression::Between {
    ...
    fn test_in_expression() {
        ...
        assert_eq!(result, DynamoExpression::In {
    ...
    fn test_function_calls() {
        ...
        assert_eq!(result, DynamoExpression::Function {
    ...
    fn test_and_expression() {
        ...
        match result {
            DynamoExpression::And(left, right) => {
                match (*left, *right) {
                    (
                        DynamoExpression::Comparison { left: left_op, operator: Comparator::GreaterOrEqual, right: right_op },
                        DynamoExpression::Comparison { left: left_op2, operator: Comparator::Equal, right: right_op2 }
                    ) => {
    ...
    fn test_not_expression() {
        ...
        match result {
            DynamoExpression::Not(inner) => {
                match *inner {
                    DynamoExpression::Function { name: FunctionName::AttributeExists, args } => {
    ...
    #[test]
    fn test_parentheses() {
        let result = parse_dynamo_expression("(age >= 18 AND age <= 65) OR status = \"vip\"").unwrap();
        match result {
    ...
    fn test_all_functions() {
        let functions = vec![
            ...
            ("attribute_not_exists(path)", FunctionName::AttributeNotExists),
    ...
    #[test]
    fn test_mixed_types() {
        let result = parse_expressions(r#"name="John" age=30 active=true score=95.5 metadata=null"#).unwrap();
        assert_eq!(result.len(), 5);

        assert_eq!(result[0], KeyValue { key: "name".to_string(), value: Value::String("John".to_string()) });
        assert_eq!(result[1], KeyValue { key: "age".to_string(), value: Value::Number(30.0) });
        assert_eq!(result[2], KeyValue { key: "active".to_string(), value: Value::Boolean(true) });
        assert_eq!(result[3], KeyValue { key: "score".to_string(), value: Value::Number(95.5) });
        assert_eq!(result[4], KeyValue { key: "metadata".to_string(), value: Value::Null });
    }
    ...
    fn test_escaped_quotes() {
        ...
        assert_eq!(result[0].value, Value::String(r#"He said "Hello" to me"#.to_string()));
    }
    ...
    fn test_legacy_compatibility() {
        ...
        assert_eq!(result[0], LegacyKeyValue { key: "key".to_string(), value: "value".to_string() });
        assert_eq!(result[1], LegacyKeyValue { key: "age".to_string(), value: "25".to_string() });
        assert_eq!(result[2], LegacyKeyValue { key: "active".to_string(), value: "true".to_string() });
