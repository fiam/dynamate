...
- `.github/workflows/release.yml` is autogenerated by `cargo-dist`; after changing dist config or release workflow settings, regenerate it with `dist generate --mode=ci` and keep it up to date.
